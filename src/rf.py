...
if __name__ == "__main__":
    ...
    for bin_size in bins:
        ...
        for img_size in img_sizes:
            train_dir = r"C:\Users\phamh\Downloads\NhapMonCV-Smoking-Image-Classification\data\Training"  # Update this path if needed
            val_dir = r"C:\Users\phamh\Downloads\NhapMonCV-Smoking-Image-Classification\data\Validation"  # Update this path if needed
            ...
            for n_estimators in n_estimators_list:
                print(f"\n\nEstimators: {n_estimators}, Bin Size: {bin_size}, Image Size: {img_size}")
                model = create_rf(n_estimators=n_estimators)
